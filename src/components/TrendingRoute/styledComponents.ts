...
export const TrendingBgContainer = styled.div<{isDarkTheme: boolean}>`
  display: flex;
  min-height: 90vh;
...
export const TrendingVideosList = styled.ul`
  ...
  margin: 0;
`
export const TrendingHeadingContainer = styled.div<{isDarkTheme: boolean}>`
  display: flex;
  align-items: center;
  padding: 24px 0 24px 48px;
  background-color: ${props => (props.isDarkTheme ? '#212121' : '#ebebeb')};
`
export const TrendingIconContainer = styled.div<{isDarkTheme: boolean}>`
  width: 64px;
  height: 64px;
  border-radius: 32px;
  ...
  margin-right: 16px;
`
export const TrendingHeading = styled.h1<{isDarkTheme: boolean}>`
  font-family: Roboto;
  font-size: 24px;
